...
class Database:
    ...
    async def update_channel_name(self, channel_id, group, new_name):
        """Update stored name for a channel in a specific group"""
        try:
            ...
            await self.log_error(f"Error updating channel name: {e}")
            return False
